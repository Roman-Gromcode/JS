...
console.log(
	"-17.17 to string is " + String(-17.17)
);
console.log(
	"false to string is " + String(false)
);
console.log("null to string is " + String(null));
console.log(
	"undefined to string is " + String(undefined)
);
...
console.log(
	"false to number is " + Number(false)
);
console.log("null to number is " + Number(null));
console.log(
	"undefined to number is " + Number(undefined)
);
console.log(
	"'   20   ' to number is " + Number("   20   ")
);
console.log(
	"'      ' to number is " + Number("      ")
);
...
/* cast to boolean */
console.log(
	"null to boolean is " + Boolean(null)
);
console.log(
	"undefined to boolean is " + Boolean(undefined)
);
...
console.log(
	"'Hello' to boolean is " + Boolean("Hello")
);
